...
public class ScannerActivity extends AppCompatActivity {
    ...
    private Button snapBtn, detectBtn,nextBtn;
            ...
            private void detectText() {
                ...
                Task<Text> result = recognizer.process(image).addOnSuccessListener(new OnSuccessListener<Text>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ScannerActivity.this, "Fail to Detect from Image.." + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, @Nullable int[] grantResults) {
